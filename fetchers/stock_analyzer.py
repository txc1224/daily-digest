...
def get_default_sector_stocks(sector: str, market: str) -> List[str]:
    ...
    defaults = {
        ...
        "有色金属": {
            "US": ["FCX", "NEM", "AA", "GOLD", "ALB"],
            "HK": ["2600.HK", "1088.HK", "3983.HK", "0358.HK"],
            "CN": ["600460.SS", "601899.SS", "002460.SZ", "000878.SZ", "600362.SS"],
        },
        "钢铁": {
            "US": ["X", "NUE", "STLD", "CLF"],
            "HK": ["0347.HK", "0323.HK"],
            "CN": ["600019.SS", "601390.SS", "000709.SZ", "600581.SS"],
        },
        "煤炭": {
            "US": ["BTU", "ARCH", "AMR"],
            "HK": ["1898.HK", "1171.HK", "3968.HK"],
            "CN": ["600188.SS", "601088.SS", "601898.SS", "600997.SS"],
        },
        "石油": {
            "US": ["XOM", "CVX", "COP", "EOG", "SLB"],
            "HK": ["0857.HK", "0386.HK", "0883.HK"],
            "CN": ["600028.SS", "601857.SS"],
        },
        "房地产": {
            "US": ["AMT", "PLD", "CCI", "SPG", "O"],
            "HK": ["1997.HK", "0016.HK", "0012.HK", "0101.HK"],
            "CN": ["600048.SS", "001979.SZ", "000002.SZ", "600606.SS"],
        },
        "半导体": {
            "US": ["NVDA", "TSM", "ASML", "AMD", "INTC"],
            "HK": ["0981.HK", "2382.HK"],
            "CN": ["603501.SS", "002049.SZ", "002415.SZ", "688012.SS"],
        },
    }
